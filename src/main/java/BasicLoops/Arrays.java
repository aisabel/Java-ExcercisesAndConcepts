...
public class Arrays {
    ...
    public static void main (String[] args) {
        ...
        //Single dimensions array described
        ...
        int[] a = new int[4]; //By adding number 4 means array size (quantity of spaces will be set up in memory)
        a[0] = 1;
        a[1] = 2;
        a[2] = 3;
        a[3] = 4;
        ...
        for (int i=0; i < c.length; i++) {
            ...
            //Prinln jump to the next row
            System.out.println("");
        }

        //Prints the value in that specific position = 3
        System.out.println("Multidimensional array value in second row, first column: "+c[1][0]);
    }
}
